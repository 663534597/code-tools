...
import static com.yijia.codegen.models.base.utils.CodeGenerationUtils.getterName;
import static com.yijia.codegen.models.base.utils.CodeGenerationUtils.setterName;
...
public class PropertyMetaModel {
	...
	public PropertyMetaModel(BaseNodeMetaModel containingNodeMetaModel, String name, Class<?> type, Optional<BaseNodeMetaModel> nodeReference, boolean isOptional,
			boolean isNonEmpty, boolean isNodeList, boolean isEnumSet, boolean hasWildcard) {
