...
import com.yijia.codegen.models.base.metamodel.ObjectCreationExprMetaModel;

/**
 * A constructor call. <br/>
 * In <code>new HashMap.Entry<String, Long>(15) {public String getKey() {return null;}};</code> HashMap is the scope, Entry is the type, String and Long are type arguments, 15 is
 * an argument, and everything in { } is the anonymous class body.
 * @author Julio Vilmar Gesser
 */
public final class ObjectCreationExpr extends Expression implements NodeWithTypeArguments<ObjectCreationExpr>, NodeWithType<ObjectCreationExpr, ClassOrInterfaceType>,
		NodeWithArguments<ObjectCreationExpr>, NodeWithOptionalScope<ObjectCreationExpr> {
	...
	public ObjectCreationExpr(final Expression scope, final ClassOrInterfaceType type, final NodeList<Type> typeArguments, final NodeList<Expression> arguments,
	...
	public ObjectCreationExpr(TokenRange tokenRange, Expression scope, ClassOrInterfaceType type, NodeList<Type> typeArguments, NodeList<Expression> arguments,
