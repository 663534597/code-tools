...
import com.yijia.codegen.models.base.metamodel.AssignExprMetaModel;
import com.yijia.codegen.models.base.metamodel.JavaParserMetaModel;
import com.yijia.codegen.models.base.printer.Printable;

/**
 * An assignment expression. It supports the operators that are found the the AssignExpr.Operator enum. <br/>
 * <code>a=5</code> <br/>
 * <code>time+=500</code>
...
public final class AssignExpr extends Expression {
	...
	public enum Operator implements Printable {
		...
		ASSIGN("="), PLUS("+="), MINUS("-="), MULTIPLY("*="), DIVIDE("/="), AND("&="), OR("|="), XOR("^="), REMAINDER("%="), LEFT_SHIFT("<<="), SIGNED_RIGHT_SHIFT(
