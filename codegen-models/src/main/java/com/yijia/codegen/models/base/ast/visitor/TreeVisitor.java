...
public abstract class TreeVisitor {
	...
	/**
	 * Performs a pre-order node traversal starting with a given node. When each node is visited, {@link #process(Node)} is called for further processing.
	...
	/**
	 * Performs a post-order node traversal starting with a given node. When each node is visited, {@link #process(Node)} is called for further processing.
	 * @param node The node at which the traversal begins.
