...
import com.yijia.codegen.models.base.metamodel.ArrayTypeMetaModel;
...
public class ArrayType extends ReferenceType implements NodeWithAnnotations<ArrayType> {
	...
	/**
	 * Takes lists of arrayBracketPairs, assumes the lists are ordered left to right and the pairs are ordered left to right, mirroring the actual code. The type gets wrapped in
	 * ArrayTypes so that the outermost ArrayType corresponds to the rightmost ArrayBracketPair.
	 */
	@SafeVarargs
