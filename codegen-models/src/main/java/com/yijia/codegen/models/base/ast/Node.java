...
import com.yijia.codegen.models.base.HasParentNode;
...
import com.yijia.codegen.models.base.ast.nodeTypes.NodeWithRange;
import com.yijia.codegen.models.base.ast.nodeTypes.NodeWithTokenRange;
import com.yijia.codegen.models.base.ast.observer.AstObserver;
import com.yijia.codegen.models.base.ast.observer.ObservableProperty;
import com.yijia.codegen.models.base.ast.observer.PropagatingAstObserver;
import com.yijia.codegen.models.base.ast.visitor.CloneVisitor;
import com.yijia.codegen.models.base.ast.visitor.EqualsVisitor;
import com.yijia.codegen.models.base.ast.visitor.HashCodeVisitor;
import com.yijia.codegen.models.base.ast.visitor.Visitable;
 ...
 * <h2>Construction</h2>
 * <p>
 * The tree is built by instantiating the required nodes, then adding them to other nodes. If it is the parser who is building the tree, it will use the largest constructor, the
 * one with "range" as the first parameter. If you want to manually instantiate nodes, we suggest to...
 * <ul>
 ...
 * <h2>Parent/child</h2>
 * <p>
 * The parent node field is managed automatically and can be seen as read only. Note that there is only one parent, and trying to use the same node in two places will lead to
 * unexpected behaviour. It is advised to clone() a node before moving it around.
 * <h2>Comments</h2>
 * <p>
 ...
 * <h2>Positions</h2>
 * <p>
 * When the parser creates nodes, it sets their source code position in the "range" field. When you manually instantiate nodes, their range is not set. The top left character is
 * position 1, 1. Note that since this is an <i>abstract</i> syntax tree, it leaves out a lot of text from the original source file, like where braces or comma's are exactly.
 ...
 * <h2>Visitors</h2>
 * <p>
 * The most comfortable way of working with an abstract syntax tree is using visitors. You can use one of the visitors in the visitor package, or extend one of them. A visitor can
 * be "run" by calling accept on a node:
 * 
 * <pre>
...
public abstract class Node implements Cloneable, HasParentNode<Node>, Visitable, NodeWithRange<Node>, NodeWithTokenRange<Node> {
	...
	public enum ObserverRegistrationMode {
		...
		JUST_THIS_NODE,
		/**
		 * Notify for changes happening on this node and all its descendants existing at the moment in which the observer was registered. Nodes attached later will not be observed.
		 */
		THIS_NODE_AND_EXISTING_DESCENDANTS,
		/**
		 * Notify for changes happening on this node and all its descendants. The descendants existing at the moment in which the observer was registered will be observed
		 * immediately. As new nodes are attached later they are automatically registered to be observed.
		 */
		SELF_PROPAGATING
	}
	...
	/**
	 * @param range the range of characters in the source code that this node covers. null can be used to indicate that no range information is known, or that it is not of
	 *            interest.
	 */
	...
	/**
	 * Contains all nodes that have this node set as their parent. You can add nodes to it by setting a node's parent to this node. You can remove nodes from it by setting a child
	 * node's parent to something other than this node.
	...
	/**
	 * This is the list of Comment which are contained in the Node either because they are properly associated to one of its children or because they are floating around inside the
	 * Node
	...
	/**
	 * Sets data for this component using the given key. For information on creating DataKey, see {@link DataKey}.
	...
	/**
	 * Forcibly removes this node from the AST. If it cannot be removed from the parent with remove(), it will try to remove its parent instead, until it finds a node that can be
	 * removed, or no parent can be found.
	 * <p>
	...
	/**
	 * Register a new observer for the given node. Depending on the mode specified also descendants, existing and new, could be observed. For more details see
	 * <i>ObserverRegistrationMode</i>.
	 */
