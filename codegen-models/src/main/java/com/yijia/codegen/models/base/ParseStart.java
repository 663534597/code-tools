...
/**
 * The start production for JavaParser. Tells JavaParser what piece of Java code it can expect. For example, COMPILATION_UNIT indicates a complete Java file, and CLASS_BODY would
 * indicate the part of a class that is within { and }.
