...
import com.yijia.codegen.models.base.metamodel.SuperExprMetaModel;

/**
 * An occurrence of the "super" keyword. <br/>
 * <code>World.super.greet()</code> is a MethodCallExpr of method name greet, and scope "World.super" which is a SuperExpr with classExpr "World". <br/>
 * <code>super.name</code> is a FieldAccessExpr of field greet, and a SuperExpr as its scope. The SuperExpr has no classExpr.
